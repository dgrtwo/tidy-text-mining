...
```{r plotgamma, dependson = "lda_gamma", fig.width=12, fig.height=16, fig.cap="Probability distribution for each topic in topic modeling of NASA metadata description field texts"}
