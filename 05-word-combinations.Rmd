...
```{r digram_tf_idf_plot, dependson = "digram_tf_idf", echo = FALSE, fig.width=9, fig.height=9}
library(ggstance)
...
```{r not_words_plot, dependson = "not_words", fig.width=9, fig.height=7}
not_words %>%
