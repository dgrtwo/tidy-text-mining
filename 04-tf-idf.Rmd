...
```{r plot_austen, dependson = "desc_idf", fig.height=6, fig.width=8}
library(ggstance)
library(ggthemes)
...
```{r plot_separate, dependson = "plot_austen", fig.height=10, fig.width=8}
...
```{r plot_physics, dependson = "physics_words", fig.width=8, fig.height=6}
