...
```{r plot_tf, dependson = "book_words", fig.height=10, fig.width=9}
library(ggplot2)
...
```{r physics_separate, dependson = "plot_physics", fig.height=7, fig.width=9}
...
```{r mystopwords, dependson = "plot_physics", fig.height=7, fig.width=9}
