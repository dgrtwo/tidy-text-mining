...
options(width = 100, dplyr.width = 150, crayon.enabled = FALSE)
library(ggplot2)
...
```{r bigramgraph, dependson = "bigram_graph", fig.width = 12, fig.height = 12, fig.cap = "Common bigrams in Jane Austen's novels, showing those that occurred more than 20 times and where neither word was a stop word"}
library(ggraph)
set.seed(2017)
...
```{r bigramggraphausten2, dependson = "bigram_graph", fig.width = 12, fig.height = 12, fig.cap = "Common bigrams in Jane Austen's novels, with some polishing"}
set.seed(2016)
...
```{r kjvbigrams, dependson = c("kjv", "visualize_bigrams"), fig.cap = "Directed graph of common bigrams in the King James Bible, showing those that occurred more than 40 times"}
library(stringr)
