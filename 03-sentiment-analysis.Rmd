...
Three sentiment lexicons are in the tidytext package in the `sentiment` dataset. 
...
Sentiment analysis can be done as an inner join. Let's look at the words with a joy score from the NRC lexicon. What are the most common joy words in *Emma*?
