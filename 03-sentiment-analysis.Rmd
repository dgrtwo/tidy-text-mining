...
```{r compareplot, dependson = "comparesentiment", fig.width=9, fig.height=7.5}
bind_rows(afinn, 
          bing_and_nrc) %>%
...
```{r pipetoplot, dependson = "wordcounts", fig.width=8, fig.height=4}
bing_word_counts %>%
  group_by(sentiment) %>%
  top_n(10) %>%
