...
```{r board_sentiments, dependson = "words_by_board", fig.width=9, fig.height=8}
AFINN <- sentiments %>%
...
```{r, dependson = "contributions", fig.width=9, fig.height=8}
contributions %>%
...
```{r negate_words, dependson = "usenet_bigram_counts", fig.width=10, fig.height=9}
